...
ImGuiStyle swan_default_imgui_style() noexcept
{
    ...
    style.Alpha = 1.000f;
    style.DisabledAlpha = 0.400f;
    style.WindowPadding.x = 10.000f;
    style.WindowPadding.y = 10.000f;
    style.WindowRounding = 2.000f;
    ...
    style.ItemSpacing.x = 8.000f;
    style.ItemSpacing.y = 8.000f;
    style.ItemInnerSpacing.x = 8.000f;
    style.ItemInnerSpacing.y = 8.000f;
    style.CellPadding.x = 8.000f;
    style.CellPadding.y = 4.000f;
    style.TouchExtraPadding.x = 0.000f;
    style.TouchExtraPadding.y = 0.000f;
    style.IndentSpacing = 16.000f;
    ...
    style.SeparatorTextBorderSize = 1.000f;
    ...
    style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.392157f);
    style.Colors[ImGuiCol_WindowBg] = ImVec4(1.000000f, 1.000000f, 1.000000f, 1.000000f);
    style.Colors[ImGuiCol_ChildBg] = ImVec4(1.000000f, 1.000000f, 1.000000f, 1.000000f);
    style.Colors[ImGuiCol_PopupBg] = ImVec4(1.000000f, 1.000000f, 1.000000f, 1.000000f);
    style.Colors[ImGuiCol_Border] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.392157f);
    style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.000000f);
    style.Colors[ImGuiCol_FrameBg] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.000000f);
    style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_TitleBg] = ImVec4(0.850980f, 0.850980f, 0.850980f, 1.000000f);
    style.Colors[ImGuiCol_TitleBgActive] = ImVec4(0.850980f, 0.850980f, 0.850980f, 1.000000f);
    style.Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.850980f, 0.850980f, 0.850980f, 1.000000f);
    style.Colors[ImGuiCol_MenuBarBg] = ImVec4(0.933333f, 0.933333f, 0.933333f, 1.000000f);
    style.Colors[ImGuiCol_ScrollbarBg] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.196078f);
    style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.196078f);
    style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_CheckMark] = ImVec4(0.274510f, 0.588235f, 0.980392f, 1.000000f);
    style.Colors[ImGuiCol_SliderGrab] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.549020f);
    style.Colors[ImGuiCol_SliderGrabActive] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_Button] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.000000f);
    style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_ButtonActive] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_Header] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.156863f);
    style.Colors[ImGuiCol_HeaderHovered] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_HeaderActive] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_Separator] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.392157f);
    style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.588235f);
    style.Colors[ImGuiCol_SeparatorActive] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.784314f);
    style.Colors[ImGuiCol_ResizeGrip] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_Tab] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.058824f);
    style.Colors[ImGuiCol_TabHovered] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_TabActive] = ImVec4(1.000000f, 0.803922f, 0.784314f, 0.862745f);
    style.Colors[ImGuiCol_TabUnfocused] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.019608f);
    style.Colors[ImGuiCol_TabUnfocusedActive] = ImVec4(1.000000f, 0.803922f, 0.784314f, 0.294118f);
    style.Colors[ImGuiCol_DockingPreview] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.549020f);
    style.Colors[ImGuiCol_DockingEmptyBg] = ImVec4(0.980392f, 0.980392f, 0.980392f, 0.980392f);
    style.Colors[ImGuiCol_PlotLines] = ImVec4(0.588235f, 0.588235f, 0.588235f, 1.000000f);
    style.Colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.000000f, 0.431373f, 0.352941f, 1.000000f);
    style.Colors[ImGuiCol_PlotHistogram] = ImVec4(0.901961f, 0.705882f, 0.000000f, 1.000000f);
    style.Colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.000000f, 0.588235f, 0.000000f, 1.000000f);
    style.Colors[ImGuiCol_TableHeaderBg] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.000000f);
    style.Colors[ImGuiCol_TableBorderStrong] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.392157f);
    style.Colors[ImGuiCol_TableBorderLight] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.196078f);
    style.Colors[ImGuiCol_TableRowBg] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.000000f);
    style.Colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.007843f);
    style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.274510f, 0.588235f, 0.980392f, 0.313726f);
    style.Colors[ImGuiCol_DragDropTarget] = ImVec4(0.274510f, 0.588235f, 0.980392f, 1.000000f);
    style.Colors[ImGuiCol_NavHighlight] = ImVec4(0.274510f, 0.588235f, 0.980392f, 1.000000f);
    style.Colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.000000f, 0.000000f, 1.000000f, 0.392157f);
    style.Colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.392157f);
    style.Colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.000000f, 0.000000f, 0.000000f, 0.392157f);
