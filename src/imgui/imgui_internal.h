...
namespace ImGui
{
    ...
    IMGUI_API void          Shutdown(char const *ini_file_path); // Since 1.60 this is a _private_ function. You can call DestroyContext() to destroy the context created by CreateContext().
